...
-   Two modes of the RStudio editor: `visual` (on the left) and `source` (on the right).
`visual`: what-you-see-is-what-you-mean (WYSIWYM) experience, so you can format text without worrying about markdown syntax.
`source`: plain-text markdown code.
